...
export function LocalLlmForm() {
    ...
    const onSubmit = async data => {
        try {
            const response = await axios.post(`${import.meta.env.VITE_API_BASE_URL}/api/models`, data);
                ...
                <>
                    ...
                    <fieldset>
                        ...
                        <div className="grid">
                            <label>
                                Generated Tokens
                                <input placeholder="e.g. 1,162 tokens" type="text" {...register("generated_tokens")} />
                            </label>
                            <label>
                                Generation Time
                                <input type="text" placeholder="e.g. 2min 14s" {...register("generation_time_s")} />
                            </label>
                        </div>
                        <label>
                            Generation Speed
                            <input placeholder="e.g. 32.27 t/s" type="text" {...register("generation_speed_tps")} />
                        </label>
                    </fieldset>
